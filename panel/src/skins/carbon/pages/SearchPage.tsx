...
import { useState, useCallback, useEffect, useRef, type FormEvent, type ComponentType } from 'react'
...
export function SearchPage() {
  ...
  const TAB_ICONS: Record<SearchCategory, ComponentType<{ size?: number }>> = {
    paper: FileText,
    patent: Shield,
    general: Globe,
    professional: Zap,
