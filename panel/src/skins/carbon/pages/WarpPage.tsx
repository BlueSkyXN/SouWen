...
const theme = {
  pagePadding: '36px 24px',
  headerPadding: '28px 28px',
  cardPadding: 24,
  card: '#161616',
  headerBg: 'linear-gradient(135deg, #161616 0%, #262626 100%)',
  border: '#393939',
  fieldBg: '#262626',
  fieldBorder: '#393939',
  modeBg: '#1f1f1f',
  ...
  warning: '#f1c21b',
  danger: '#ff8389',
  successSoft: 'rgba(66, 190, 101, 0.13)',
  warningSoft: 'rgba(241, 194, 27, 0.13)',
  dangerSoft: 'rgba(255, 131, 137, 0.13)',
  surfaceMuted: '#393939',
  successBorder: 'rgba(66, 190, 101, 0.35)',
  warningBorder: 'rgba(241, 194, 27, 0.35)',
  dangerBorder: 'rgba(255, 131, 137, 0.35)',
  primaryButtonBg: '#0f62fe',
  primaryButtonBorder: '#0f62fe',
  primaryButtonText: '#ffffff',
  secondaryButtonBg: '#262626',
  radius: 0,
  fieldRadius: 0,
  inputRadius: 0,
  buttonRadius: 0,
  badgeRadius: 0,
  shadow: 'none',
  activeShadow: 'inset 4px 0 0 #0f62fe',
  titleSize: 34,
  titleWeight: 400,
  titleSpacing: '-0.02em',
  letterSpacing: '0.08em',
  inputPadding: '12px 12px',
} as const
