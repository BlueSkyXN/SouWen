 ...
 * 视频中心页面 - Apple 皮肤版本
 *
 * 文件用途：YouTube 热门视频、视频搜索、Bilibili 搜索和字幕提取的统一入口（Apple 风格）
 *
 * 业务逻辑统一抽取至 `@core/hooks/useVideoPage`，本文件仅保留 Apple 皮肤特有的 UI 渲染。
 */

import { m } from 'framer-motion'
import {
  Play, Search as SearchIcon, FileText, Copy, ExternalLink,
  Clock, Eye, ThumbsUp, MessageCircle, Tv, MessageSquare, Tv2,
} from 'lucide-react'
import {
  useVideoPage,
