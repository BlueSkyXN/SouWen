/**
 * WARP 专属管理页面 - souwen-google skin
 *
...
const theme = {
  ...
  headerPadding: '28px 30px',
  cardPadding: 24,
  card: '#ffffff',
  headerBg: 'linear-gradient(135deg, #ffffff 0%, #f8fbff 100%)',
  border: '#dfe5f2',
  fieldBg: '#f8fafd',
  fieldBorder: '#e5e9f2',
  modeBg: '#ffffff',
  ...
  warningBorder: '#fde293',
  dangerBorder: '#f4c7c3',
  primaryButtonBg: '#1a73e8',
  primaryButtonBorder: '#1a73e8',
  ...
  buttonRadius: 999,
  badgeRadius: 999,
  shadow: '0 12px 32px rgba(60, 64, 67, 0.10)',
  activeShadow: '0 0 0 3px rgba(26, 115, 232, 0.14)',
  titleSize: 36,
  titleWeight: 500,
  titleSpacing: '-0.04em',
