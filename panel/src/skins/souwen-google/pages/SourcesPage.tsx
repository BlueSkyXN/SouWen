                  ...
                  {list.map((src) => {
                    ...
                    return (
                      <tr key={src.name} className={!src.enabled ? styles.listRowDisabled : ''}>
                        ...
                        <td className={styles.listMessage}>
                ...
                <div className={styles.sourceCardHeader}>
                  ...
                  >
                    ...
                    <span className={styles.cardBody}>
                      ...
                      {src.description && (
                        <span className={styles.sourceDescription}>{src.description}</span>
                      )}
                  ...
                  >
                    ...
                    <div className={styles.matrixChips}>
                      {group.items.map((src) => {
                        const availability = getAvailability(src)
                        return (
                          <span key={src.name} className={styles.matrixChip} title={availability.message}>
