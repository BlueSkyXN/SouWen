...
export type Provider = 'builtin' | 'jina_reader' | 'tavily' | 'firecrawl' | 'exa' | 'crawl4ai' | 'scrapfly' | 'diffbot' | 'scrapingbee' | 'zenrows' | 'scraperapi' | 'apify' | 'cloudflare' | 'wayback' | 'newspaper' | 'readability'
