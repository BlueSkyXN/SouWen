...
export interface BilibiliSubtitle {
  ...
  lang_doc: string
  subtitle_url: string
  lines: BilibiliSubtitleLine[]
  full_text: string
}

export interface BilibiliAISummary {
  bvid: string
  title: string
  summary: string
  outline: Array<{
...
export interface BilibiliPopularVideo {
  bvid: string
  title: string
  pic: string
  owner: BilibiliVideoOwner
...
export interface BilibiliRankVideo {
  bvid: string
  title: string
  pic: string
  owner: BilibiliVideoOwner
...
export interface BilibiliUserVideoItem {
  bvid: string
  title: string
  description: string
  pic: string
...
export interface BilibiliRelatedVideo {
  bvid: string
  title: string
  pic: string
  owner: BilibiliVideoOwner
