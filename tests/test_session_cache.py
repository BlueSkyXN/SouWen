...
覆盖 ``souwen.common_runtime.provider_support.session_cache`` 中异步会话与 OAuth Token 缓存。
...
from souwen.common_runtime.provider_support.session_cache import SessionCache
...
class TestConcurrentInit:
    ...
    async def test_concurrent_get_db_returns_single_connection(self, tmp_path, monkeypatch):
        ...
        import souwen.common_runtime.provider_support.session_cache as sc_mod
