...
| POST | `/api/v1/search` | RC6 canonical Search |
| POST | `/api/v1/llm-search` | RC6 canonical LLM Search；正式 promotion 必须配置并 live 验证 |
| POST | `/api/v1/fetch` | RC6 canonical Fetch + private Browser Worker fallback |
| GET | `/api/v1/providers` | RC6 Provider availability catalog |
