...
_reg("twitter", "social", "official_api", "twitter_bearer_token", description="Twitter/X 推文搜索（API v2）")
_reg("facebook", "social", "official_api", "facebook_app_id", description="Facebook 页面/地点搜索（Graph API）")
