"""Provider v2 bridge for wikipedia's legacy web Search client."""
...
class WikipediaSearchProvider(LegacySearchProvider):
...
_SPEC = LegacySearchSpec(_PROVIDER_ID, "knowledge", _invoke, _project)
