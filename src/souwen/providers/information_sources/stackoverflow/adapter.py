"""Provider v2 bridge for stackoverflow's legacy web Search client."""
...
class StackOverflowSearchProvider(LegacySearchProvider):
...
_SPEC = LegacySearchSpec(_PROVIDER_ID, "developer", _invoke, _project)
