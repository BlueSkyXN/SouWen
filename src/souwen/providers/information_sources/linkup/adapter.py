"""Provider v2 bridge for linkup's legacy web Search client."""
...
class LinkupSearchProvider(LegacySearchProvider):
    def __init__(self, client: LinkupClientProtocol, *, enabled: bool = True) -> None:
...
__all__ = ["LinkupClientProtocol", "LinkupSearchProvider"]
