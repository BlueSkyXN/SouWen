"""Provider v2 bridge for brave_api's legacy web Search client."""
...
_PROVIDER_ID = "brave_api"


class BraveApiClientProtocol(Protocol):
    async def search(self, query: str, max_results: int = 10) -> Any: ...


class BraveApiSearchProvider(LegacySearchProvider):
    def __init__(self, client: BraveApiClientProtocol, *, enabled: bool = True) -> None:
...
__all__ = ["BraveApiClientProtocol", "BraveApiSearchProvider"]
