"""Provider v2 bridge for aliyun_iqs's legacy web Search client."""
...
_PROVIDER_ID = "aliyun_iqs"


class AliyunIQSClientProtocol(Protocol):
    async def search(self, query: str, max_results: int = 10) -> Any: ...


class AliyunIQSSearchProvider(LegacySearchProvider):
    def __init__(self, client: AliyunIQSClientProtocol, *, enabled: bool = True) -> None:
...
__all__ = ["AliyunIQSClientProtocol", "AliyunIQSSearchProvider"]
