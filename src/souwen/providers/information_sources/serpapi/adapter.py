"""Provider v2 bridge for serpapi's legacy web Search client."""
...
class SerpApiSearchProvider(LegacySearchProvider):
    def __init__(self, client: SerpApiClientProtocol, *, enabled: bool = True) -> None:
...
__all__ = ["SerpApiClientProtocol", "SerpApiSearchProvider"]
