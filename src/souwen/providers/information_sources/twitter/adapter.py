"""Provider v2 bridge for twitter's existing web Search client."""
...
class TwitterSearchProvider(ClientSearchProvider):
    def __init__(self, client: TwitterClientProtocol, *, enabled: bool = True) -> None:
...
__all__ = ["TwitterClientProtocol", "TwitterSearchProvider"]
