"""Provider v2 bridge for linuxdo's legacy web Search client."""
...
class LinuxDoSearchProvider(LegacySearchProvider):
...
_SPEC = LegacySearchSpec(_PROVIDER_ID, "cn_tech", _invoke, _project)
