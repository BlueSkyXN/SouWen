"""Provider v2 bridge for feishu_drive's legacy web Search client."""
...
class FeishuDriveSearchProvider(LegacySearchProvider):
...
_SPEC = LegacySearchSpec(_PROVIDER_ID, "office", _invoke, _project)
