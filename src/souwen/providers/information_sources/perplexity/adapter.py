"""Provider v2 bridge for perplexity's legacy web Search client."""
...
class PerplexitySearchProvider(LegacySearchProvider):
    def __init__(self, client: PerplexityClientProtocol, *, enabled: bool = True) -> None:
...
__all__ = ["PerplexityClientProtocol", "PerplexitySearchProvider"]
