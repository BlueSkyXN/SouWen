...
模块依赖：
    ...
    - souwen.common_runtime.provider_support.scraper.base.BaseScraper: 爬虫基类（提供 TLS 指纹、限流、重试）
    - souwen.providers.runtime_clients.models: 统一数据模型
    - souwen.common_runtime.provider_support.exceptions: NotFoundError
"""
...
from souwen.common_runtime.provider_support.browser_pool import get_browser_pool
...
logger = logging.getLogger("souwen.providers.runtime_clients.patent.google_patents_scraper")
