...
模块依赖：
    ...
    - souwen.common_runtime.provider_support.exceptions: ConfigError
    - souwen.common_runtime.provider_support.http_client: SouWenHttpClient 基类
    - souwen.providers.runtime_clients.models: FetchResponse, FetchResult
    - souwen.providers.runtime_clients.web._html_extract: HTML → Markdown/文本 回退提取
...
logger = logging.getLogger("souwen.providers.runtime_clients.web.cloudflare_browser")
