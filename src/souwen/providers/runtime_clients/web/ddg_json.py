...
from souwen.providers.runtime_clients.web.ddg_utils import extract_vqd, parse_next_offset

logger = logging.getLogger("souwen.providers.runtime_clients.web.ddg_json")
