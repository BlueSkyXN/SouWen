...
模块依赖：
    ...
    - souwen.providers.runtime_clients.models: str, WebSearchResult, WebSearchResponse 数据模型
...
logger = logging.getLogger("souwen.providers.runtime_clients.web.exa")
...
class ExaClient(SouWenHttpClient):
    ...
    async def find_similar(
        ...
        """
        from souwen.providers.runtime_clients.web.fetch import raise_if_fetch_url_blocked
