...
模块依赖：
    ...
    - souwen.providers.runtime_clients.web._html_extract: extract_from_html 共享 HTML→Markdown 提取工具
...
logger = logging.getLogger("souwen.providers.runtime_clients.web.scraperapi")
