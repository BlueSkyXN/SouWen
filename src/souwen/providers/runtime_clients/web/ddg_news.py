...
from souwen.providers.runtime_clients.web.ddg_json import DDGJsonClient
from souwen.providers.runtime_clients.web.ddg_utils import normalize_text

logger = logging.getLogger("souwen.providers.runtime_clients.web.ddg_news")
