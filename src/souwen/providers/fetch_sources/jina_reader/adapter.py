"""Canonical Jina Reader Fetch bridge over the SSRF-safe legacy client."""
...
class JinaReaderFetchProvider(LegacyFetchProvider):
    capability = "fetch"
...
_FETCH_SPEC = LegacyFetchSpec(JINA_READER_FETCH_PROFILE.provider_id, _invoke, _project)
