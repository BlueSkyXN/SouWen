"""Canonical ScraperAPI Fetch bridge over the SSRF-safe existing client."""
...
class ScraperAPIFetchProvider(ClientFetchProvider):
    capability = "fetch"
...
_FETCH_SPEC = ClientFetchSpec(SCRAPERAPI_FETCH_PROFILE.provider_id, _invoke, _project)
