"""Canonical ScrapingBee Fetch bridge over the SSRF-safe legacy client."""
...
class ScrapingBeeFetchProvider(LegacyFetchProvider):
    capability = "fetch"
...
_FETCH_SPEC = LegacyFetchSpec(SCRAPINGBEE_FETCH_PROFILE.provider_id, _invoke, _project)
