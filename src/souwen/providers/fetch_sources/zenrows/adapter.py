"""Canonical ZenRows Fetch bridge over the SSRF-safe legacy client."""
...
class ZenRowsFetchProvider(LegacyFetchProvider):
    capability = "fetch"
...
_FETCH_SPEC = LegacyFetchSpec(ZENROWS_FETCH_PROFILE.provider_id, _invoke, _project)
