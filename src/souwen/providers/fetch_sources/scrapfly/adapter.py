"""Canonical Scrapfly Fetch bridge over the SSRF-safe legacy client."""
...
class ScrapflyFetchProvider(LegacyFetchProvider):
    capability = "fetch"
...
_FETCH_SPEC = LegacyFetchSpec(SCRAPFLY_FETCH_PROFILE.provider_id, _invoke, _project)
