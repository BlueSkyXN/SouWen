"""Canonical Apify Fetch bridge over the SSRF-safe legacy client."""
...
class ApifyFetchProvider(LegacyFetchProvider):
    capability = "fetch"
...
_FETCH_SPEC = LegacyFetchSpec(APIFY_FETCH_PROFILE.provider_id, _invoke, _project)
