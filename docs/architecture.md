...
**Registry 摘要**：当前内置 registry 共 **95** 个 registered `SourceAdapter`，其中 **94** 个进入 public Source Catalog，**1** 个为 hidden/internal。

- 公开源主 domain：`paper` 18 · `patent` 8 · `web` 30 · `social` 5 · `video` 2 · `knowledge` 1 · `developer` 2 · `cn_tech` 9 · `office` 1 · `archive` 1
